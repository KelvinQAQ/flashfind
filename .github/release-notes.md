...
| 平台 | CPU 架构 | 文件 |
|---|---|---|
| Linux | x86_64（Intel/AMD 64-bit） | `flashfind-v0.1.10-linux-x86_64.tar.gz` |
| Linux | aarch64（ARM64） | `flashfind-v0.1.10-linux-aarch64.tar.gz` |
| Windows | x86_64（Intel/AMD 64-bit） | `flashfind-v0.1.10-windows-x86_64.zip` |
| Windows | aarch64（ARM64） | `flashfind-v0.1.10-windows-aarch64.zip` |
